...
class DeploymentTest < ActiveSupport::TestCase
  ...
  def test_validation
    ...
    d = Deployment.new
    assert !d.valid?
    assert d.errors['task'].any?
    assert d.errors['stage'].any?
    assert d.errors['description'].empty?
    assert d.errors['user'].any?
    ...
    assert d.errors['description'].empty?
    assert d.errors['task'].any?
    assert d.errors['stage'].empty?
    d.task = 'deploy:setup'
    assert !d.valid?
    assert d.errors['user'].any?
    assert d.errors['description'].empty?
    assert d.errors['task'].empty?
    assert d.errors['stage'].empty?
  ...
  def test_check_of_stage_prompt_configuration_in_validation
    ...
    assert !deployment.valid?
    assert deployment.errors['base'].any?
    ...
    assert deployment.errors['base'].empty?
  end
